// Vendored verbatim from ../../../omarchy/shell/Commons/Util.qml - pure,
// stateless helpers, no Omarchy-specific dependency. See Style.qml's
// header comment in this same directory.
pragma Singleton
import Quickshell
import QtQuick
